  ...
  lazy val dist = (
    ...
    settings(
      ...
      localRepoArtifacts ++= Seq(
        ...
        Defaults.sbtPluginExtra("com.typesafe.play" % "sbt-plugin" % "2.4.3", "0.13", "2.10"),
        "com.typesafe.play" % "play-jdbc_2.11" % "2.4.3",
        "com.typesafe.play" % "anorm_2.11" % "2.4.3",
        "com.typesafe.play" % "play-cache_2.11" % "2.4.3",
        "com.typesafe.play" % "play-docs_2.11" % "2.4.3",
        "com.typesafe.play" % "play-specs2_2.11" % "2.4.3",
        "com.typesafe.play" % "play-omnidoc_2.11" % "2.4.3",
        "org.scalaz.stream" % "scalaz-stream_2.11" % "0.7a",
        "org.specs2" % "specs2-matcher-extra_2.11" % "3.6",
        "com.typesafe.play" % "play-test_2.11" % "2.4.3",
        "com.typesafe.play" % "play-java_2.11" % "2.4.3",
        "com.typesafe.play" % "play-java-jdbc_2.11" % "2.4.3",
        "com.typesafe.play" % "play-java-ebean_2.11" % "2.4.3",
        "com.typesafe.play" % "play-java-ws_2.11" % "2.4.3",
