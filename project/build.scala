  ...
  lazy val dist = (
    ...
    settings(
      ...
      localRepoArtifacts ++= Seq(
        ...
        "com.typesafe.play" % "anorm_2.11" % "2.4.2",
        "com.typesafe.play" % "play-cache_2.11" % "2.4.2",
        "com.typesafe.play" % "play-docs_2.11" % "2.4.2",
        "com.typesafe.play" % "play-specs2_2.11" % "2.4.2",
        "com.typesafe.play" % "play-omnidoc_2.11" % "2.4.2",
        ...
        "com.typesafe.play" % "play-java-jdbc_2.11" % "2.4.2",
        "com.typesafe.play" % "play-java-ebean_2.11" % "2.4.2",
