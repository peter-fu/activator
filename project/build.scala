  ...
  lazy val dist = (
    ...
    settings(
      ...
      localRepoArtifacts ++= Seq(
        ...
        "com.typesafe.play" % "play-server_2.11" % "2.5.0",
        "com.typesafe.play" % "play-java_2.11" % "2.5.0",
        "com.typesafe.play" % "play-netty-server_2.11" % "2.5.0",
        "com.typesafe.play" % "play-logback_2.11" % "2.5.0",
        "com.typesafe.play" % "play-java-jdbc_2.11" % "2.5.0",
        "com.typesafe.play" % "play-cache_2.11" % "2.5.0",
        "com.typesafe.play" % "play-java-ws_2.11" % "2.5.0",
        "com.typesafe.play" % "play-test_2.11" % "2.5.0",
        "com.typesafe.play" % "play-omnidoc_2.11" % "2.5.0",
        "org.scalatestplus.play" % "scalatestplus-play_2.11" % "1.5.0-RC1",
