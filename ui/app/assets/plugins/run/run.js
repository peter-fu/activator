...
define([
  ...
  var inspectActivatedAndAppReady = ko.computed(function() {
    return monitoringSolutions.inspectActivated() && sbt.tasks.applicationReady();
  });

  var inspectActivatedAndAvailable = ko.computed(function() {
    return inspectActivatedAndAppReady() && sbt.tasks.inspectSupported();
  });

  inspectActivatedAndAppReady.subscribe(function(value) {
    if (value && !sbt.tasks.inspectSupported()) {
      setTimeout(function() {
        // Disactivating
